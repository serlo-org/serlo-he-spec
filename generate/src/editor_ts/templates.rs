pub const RENDERER_INDEX: &str = r#"/* generated by serlo_he_specgen, do not change manually! */
{{#each imports ~}}
{{this}}
{{~ /each}}
...
pub const EDIT_INDEX: &str = r#"/* generated by serlo_he_specgen, do not change manually! */
import {
